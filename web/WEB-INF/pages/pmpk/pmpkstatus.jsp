<%-- 
    Document   : pmpkstatus
    Created on : 10.02.2017, 13:40:47
    Author     : Aiglu
--%>
...
<html>
    <head>
        ...
        <title>Реестр детей со статусами</title>
    </head>
    <body>
        <c:if test="${user.getRoleId().getRoleName().equals('administrator')}">
        <p>Реестр детей, прошедших ПМПК и их статусы
            ...
            <input type="button" value="Получить реестр" onclick="printpmpkstatus()">
    </c:if>
    </body>
</html>
