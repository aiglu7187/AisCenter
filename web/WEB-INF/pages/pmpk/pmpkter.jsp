<%-- 
    Document   : pmpkter
    Created on : 15.02.2017, 20:00:38
    Author     : Aiglu
--%>
...
<html>
    <head>
        ...
        <title>Реестр детей, прошедших ПМПК по направлению ТПМПК</title>
    </head>
    <body>
        <c:if test="${user.getRoleId().getRoleName().equals('administrator')}">
        <p>Реестр детей, прошедших ПМПК по направлению ТПМПК
            ...
            <input type="button" value="Получить реестр" onclick="printpmpkter()">
    </c:if>
    </body>
</html>
