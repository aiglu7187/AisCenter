...
<html>
    <head>
        ...
        <script type="text/javascript" src="priyomview0113.js" charset="utf-8"></script>
        ...
        <c:if test="${user != null}">
            <form id="formPriyom" action="savepriyom" accept-charset="windows-1251" method="POST">
                ...
                <div id="divButton">
                    ...
                    <c:if test="${!copy}">
                        <c:if test="${(priyom.getSpruslId().getSpruslName() == 'Групповое консультирование') || (priyom.getSpruslId().getSpruslName() == 'Групповое обследование')}">
