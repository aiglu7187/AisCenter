...
function printpmpkfirstovz() {
    ...
    if (validotchet()) {
        var url = "print?type=pmpkfirstovz&date1=" + d1 + "&date2=" + d2 + "&reg=" + reg;
        window.open(url, '_blank');
    }
}

function printconsultage() {
    var date1 = document.getElementById("date1");
    var d1 = "";
    if (date1 != null) {
        d1 = date1.value;
    ...
    if (validotchet()) {
        var url = "print?type=consultage&date1=" + d1 + "&date2=" + d2 + "&agen=" + agen + "&agek=" + agek;
        window.open(url, '_blank');
    }

}
function printconsultagereestr() {
    var date1 = document.getElementById("date1");
    var d1 = "";
    if (date1 != null) {
        d1 = date1.value;
    ...
    if (validotchet()) {
        var url = "print?type=consultagereestr&date1=" + d1 + "&date2=" + d2 + "&agen=" + agen + "&agek=" + agek;
        window.open(url, '_blank');
    }
}
...
function printstatuslkat() {
    ...
    if (validotchet()) {
        var url = "print?type=statuslkat&date1=" + d1 + "&date2=" + d2;
        window.open(url, '_blank');
    }
}
...
function printrpmpkconsult(){
    ...
    if (validotchet()) {
        var url = "print?type=pmpkconsult&date1=" + d1 + "&date2=" + d2 + "&reg=";
        window.open(url, '_blank');
    }
}