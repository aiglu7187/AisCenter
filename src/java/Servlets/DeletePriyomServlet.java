 ...
 * @author Aiglu
 */
// сервлет удаления приема
@WebServlet(name = "DeletePriyomServlet",
            loadOnStartup = 1,
            urlPatterns = "/deletepriyom")
public class DeletePriyomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String priyomIdS = request.getParameter("id");
        Integer priyomId = 0;
        try{
        ...
        if (priyomId != 0){
            Priyom priyom = priyomFacade.findById(priyomId);
