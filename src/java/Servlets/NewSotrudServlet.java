 ...
 * @author Aiglu
 */
@WebServlet(name = "NewSotrudServlet",
        loadOnStartup = 1,
        urlPatterns = "/newsotrud")

public class NewSotrudServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("dolgn", dolgnList);

        String url = "";
        String userPath = request.getServletPath();
        if (userPath.equals("/newsotrud")) {
            userPath = "/admin/newsotrud";
