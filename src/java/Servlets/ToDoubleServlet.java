 ...
 * @author Aiglu
 */
// сервлет для перехода на страницу слияния дублей
@WebServlet(name = "ToDoubleServlet",
        loadOnStartup = 1,
        urlPatterns = "/todouble")

public class ToDoubleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/todouble")) {
            userPath = "/admin/doubleclient";
