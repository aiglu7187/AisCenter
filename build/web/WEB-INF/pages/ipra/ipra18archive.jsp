<%-- 
    Document   : ipraarchive
    Created on : 24.06.2017, 13:50:34
    Author     : Aiglu
--%>
...
<html>
    <head>
        ...
        <title>Архив завершенных ИПРА 2018</title>
    </head>
    <body>
        <c:if test="${user.getRoleId().getRoleName().equals('ipra') || user.getRoleId().getRoleName().equals('administrator')}">
            <div id="divSearch">
                ...
                <br> 
                <input type="button" id="searchBtn" value="Поиск" onclick="searchIpraArchive()">
                <input type="button" id="clearSearchBtn" value="Очистить поиск" onclick="clearSearchArchive()">
                <br>
                <br>
